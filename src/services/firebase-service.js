 ...
 * }
 */
function importerDonnees(_activRechercherFunnels, _dateMaxLimite, _dateMinLimite){ // format de dateMinLimite et dateMaxLimite  : undefined ou Date
// TODO : gérer une date maximal et minimale (pour tests) spécifique
  ...
  return new Promise((resolve, reject) => {
    ...
    /**/
      getActionsUtilisateur(aSessions, _dateMaxLimite, _dateMinLimite, _activRechercherFunnels).then( oData=>{ 
        resolve(oData);
      },
      (error)=>{
  ...
  * }
  */
 function getActionsUtilisateur(_aSessions, _dateMaxLimite, _dateMinLimite, _activRechercherFunnels){
