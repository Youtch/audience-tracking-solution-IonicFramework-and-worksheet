...
/**
 * [importerJeuDonnees description]
 * @param  {Object} _firebaseService        [description]
 * @param  {string} _dateMaxLimite          [description]
 * @param  {string} _dateMinLimite          [description]
 * @return {
...
/**
 * [mockData_importerDonnees description]
 * @param  {[type]} _firebaseService [description]
 * @param  {[type]} _dateMaxLimite   [description]
 * @param  {[type]} _dateMinLimite   [description]
 * @return {
 *  metadata:{dateDebut:string, dateFin:string, nbActionsUtilisateurs:string, nbSessionsUtilisateurs:string}
 *  data:Array<{key, composantUI, date, page, statsSessionId,
 *    sessionKey, androidVersion, licenceEstPremium,
