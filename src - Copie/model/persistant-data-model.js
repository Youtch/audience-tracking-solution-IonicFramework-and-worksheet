...
function set_reglagesApp(_modeleFichierCsv=null, _databaseUrl=null, _serviceAccount=null){
  // modeleFichierCsv:string, databaseUrl:string, serviceAccount:string, UITheme:number
  try{
...
function set_reglagesApp_UI(_UITheme=null){ // TODO : défaut null à supprimer ?
  ...
  try{
  	...
  	if(_UITheme==null)
  	  ...
  	  var reglagesApp = get_reglagesApp();
  	  JSONContent= '{"modeleFichierCsv":"'+reglagesApp.modeleFichierCsv+'", "databaseUrl":"'+reglagesApp.databaseUrl+'", "serviceAccount":"'+reglagesApp.serviceAccount+
	  '", "UITheme":"'+_UITheme +
	'"}'
	}
	localStorageService.setItem( idUser+'-reglagesApp', '{"reglagesApp":'+JSONContent+'}');
