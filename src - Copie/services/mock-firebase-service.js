 ...
 * }
 */
function mockData_importerDonnees(_dateMaxLimite, _dateMinLimite){ // format de dateMinLimite et dateMaxLimite  : undefined ou Date
...
/* OPTIMISATION DE LA CUSTOMISATION DU CODE par l'administrateur

            foreach.constants.Libelles{ (keyConstant)=>{
              // TODO faire : 
              ajouter une attribut dans une var de type objet ainsi   keyConstant est affecté par aStats[i][val]
              NB : vérifier la pertinence de récupérer aStats[i][keyConstant] 
            }
*/
